...
define(function (require, exports, module) {
    ...
    function _getRaphaelIcon(file) {
        ...
        var elDaily = paper.path(file).attr({fill: 'orange'});
        elDaily.transform('t30,30,s2');
        return divDaily;
    }
    ...
    function _shortViewIcons() {
        ...
        this.gridIconsMod = new Modifier({
            ...
            transform: Transform.translate(0, 720, 0)
        });
        ...
        this.dailyNewsIcon = new Surface({
            size: [200, 200], properties: {cursor: 'pointer'},
            content: _getRaphaelIcon(dailySvg)
        });
        ...
        this.weeklyNewsIcon = new Surface({
            size: [200, 200], properties: {cursor: 'pointer'},
            content: _getRaphaelIcon(weeklySvg)
        });
