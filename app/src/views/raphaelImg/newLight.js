define(function (require, exports, module) {
    ...
    function _newLightSvg() {
        ...
        var backdrop = paper.set();
        var rect_a = paper.rect(0, 12.541, 120, 24.918).attr({
            y: '12.541',
            fill: '#314D9B',
            parent: 'backdrop',
            'stroke-width': '0',
        ...
        var path_p = paper.path("M62.221,27.795V28.6h16.536c-0.067-0.258-0.124-0.523-0.158-0.805H62.221z").attr({
            fill: '#BF2033',
            parent: 'red_lines',
            'stroke-width': '0',
            'stroke-opacity': '1'
        }).data('id', 'path_p');
        var path_q = paper.path("M78.591,26.185h-8.209v0.805h8.154c0-0.023-0.005-0.043-0.005-0.066 C78.531,26.665,78.567,26.428,78.591,26.185z").attr({
            fill: '#BF2033',
            parent: 'red_lines',
            'stroke-width': '0',
            'stroke-opacity': '1'
        }).data('id', 'path_q');
        var path_r = paper.path("M78.942,24.573h-8.561v0.806h8.336C78.78,25.103,78.844,24.827,78.942,24.573z").attr({
            fill: '#BF2033',
            parent: 'red_lines',
            'stroke-width': '0',
            'stroke-opacity': '1'
        }).data('id', 'path_r');
        var path_s = paper.path("M79.955,22.963h-9.573v0.806h8.967C79.521,23.481,79.727,23.215,79.955,22.963z").attr({
            fill: '#BF2033',
            parent: 'red_lines',
            'stroke-width': '0',
            'stroke-opacity': '1'
        ...
        var rect8796 = paper.rect(62.221, 21.347, 8.161, 5.639).attr({
            id: 'rect8796',
            x: '62.221',
            y: '21.347',
            fill: '#213065',
