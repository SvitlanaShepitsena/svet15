...
var backdrop = rsr.set();
var rect_a = rsr.rect(0, 12.541, 120, 24.918).attr({
    y: '12.541',
    fill: '#314D9B',
    parent: 'backdrop',
    'stroke-width': '0',
...
var path_n = rsr.path("M62.221,31.176v0.86h20.058c-0.706-0.164-1.323-0.451-1.852-0.86H62.221z").attr({
    fill: '#BF2033',
    parent: 'red_lines',
    'stroke-width': '0',
    'stroke-opacity': '1'
}).data('id', 'path_n');
var path_o = rsr.path("M62.221,30.318H79.58c-0.202-0.267-0.374-0.553-0.517-0.86H62.221V30.318z").attr({
    fill: '#BF2033',
    parent: 'red_lines',
    'stroke-width': '0',
    'stroke-opacity': '1'
}).data('id', 'path_o');
var path_p = rsr.path("M62.221,27.795V28.6h16.536c-0.067-0.258-0.124-0.523-0.158-0.805H62.221z").attr({
    fill: '#BF2033',
    parent: 'red_lines',
    'stroke-width': '0',
    'stroke-opacity': '1'
}).data('id', 'path_p');
var path_q = rsr.path("M78.591,26.185h-8.209v0.805h8.154c0-0.023-0.005-0.043-0.005-0.066 C78.531,26.665,78.567,26.428,78.591,26.185z").attr({
    fill: '#BF2033',
    parent: 'red_lines',
    'stroke-width': '0',
    'stroke-opacity': '1'
}).data('id', 'path_q');
var path_r = rsr.path("M78.942,24.573h-8.561v0.806h8.336C78.78,25.103,78.844,24.827,78.942,24.573z").attr({
    fill: '#BF2033',
    parent: 'red_lines',
    'stroke-width': '0',
    'stroke-opacity': '1'
}).data('id', 'path_r');
var path_s = rsr.path("M79.955,22.963h-9.573v0.806h8.967C79.521,23.481,79.727,23.215,79.955,22.963z").attr({
    fill: '#BF2033',
    parent: 'red_lines',
    'stroke-width': '0',
    'stroke-opacity': '1'
}).data('id', 'path_s');
var path_t = rsr.path("M80.856,22.157c0.511-0.357,1.088-0.603,1.715-0.764v-0.042H70.382v0.806H80.856z").attr({
    fill: '#BF2033',
    parent: 'red_lines',
    'stroke-width': '0',
    'stroke-opacity': '1'
...
var rsrGroups = [backdrop, objects, red_lines, banner, layer5];
backdrop.push(rect_a);
objects.push(path_b, path_c, path_d, path_e, path_f, path_g, path_h, path_i, path_j, path_k, path_l, path_m);
red_lines.push(path_n, path_o, path_p, path_q, path_r, path_s, path_t);
banner.push();
