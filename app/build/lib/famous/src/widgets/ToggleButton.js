...
//        this.arbiter.setMode(ToggleButton.ON, this.options.inTransition);
    ...
    ToggleButton.prototype.setOptions = function setOptions(options) {
        if (options.scrollview !== undefined) {
            if (!(options.scrollview instanceof Array))
                options.scrollview = [options.scrollview, options.scrollview];
            this.options.scrollview = options.scrollview;
            this.offSurface.setContent(this.options.scrollview[0]);
            this.onSurface.setContent(this.options.scrollview[1]);
        }
